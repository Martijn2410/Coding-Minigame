...
{
    public class TurnLeftCommand : BaseRotateCommand
    {
        private readonly float degrees;
        private readonly float duration;

        public TurnLeftCommand(ExecutableContext context, float degrees, float duration) : base(context)
        {
        ...
        {
            return new TurnLeftCommand(context, degrees, duration);
        }
    }
}
